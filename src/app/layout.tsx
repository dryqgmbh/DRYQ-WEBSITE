...
export const metadata: Metadata = {
  ...
  openGraph: { title: 'DRYQ GmbH – Wasserschadensanierung', description: 'Professionelle Wasserschadensanierung im Rheinland.', type: 'website', locale: 'de_DE' },
}
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="de" className="scroll-smooth"><body className={inter.className}>{children}</body></html>
}
