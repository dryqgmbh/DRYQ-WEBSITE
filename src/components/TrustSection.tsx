      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {signals.map(({ Icon, title, text }) => (
            <div key={title} className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 hover:border-[#35D04F]/25 transition-all reveal">
              <div className="w-10 h-10 bg-[#35D04F]/10 rounded-xl flex items-center justify-center mb-4">
