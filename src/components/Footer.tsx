...
export default function Footer() {
  return (
    <footer className="bg-[#101820] border-t border-white/10 pb-20 md:pb-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-14">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-0.5 mb-4">
              ...
              <span className="text-[10px] text-gray-500 font-semibold ml-1.5 self-end pb-0.5">GmbH</span>
            </div>
            <p className="text-sm text-gray-500 leading-relaxed mb-5">Professionelle Wasserschadensanierung, Leckortung und technische Trocknung für Eigentümer, Verwaltungen und Gewerbekunden.</p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Wasserschadensanierung','Leckortung','Technische Trocknung','Estrichdämmschichttrocknung','Bautrocknung','Rückbau & Demontage','Schimmelprävention'].map((l) => (
                <li key={l}><a href="#leistungen" className="text-sm text-gray-500 hover:text-[#35D04F] transition-colors">{l}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[['Privatkunden','#verwaltungen'],['Hausverwaltungen','#verwaltungen'],['Gewerbekunden','#verwaltungen'],['Versicherungen','#versicherung'],['Sachverständige','#versicherung']].map(([l,h]) => (
                <li key={l}><a href={h} className="text-sm text-gray-500 hover:text-[#35D04F] transition-colors">{l}</a></li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                ...
                <address className="not-italic text-sm text-gray-500 leading-relaxed">DRYQ GmbH<br />Musterstraße 1<br />53721 Siegburg</address>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-600">&copy; {year} DRYQ GmbH. Alle Rechte vorbehalten.</p>
